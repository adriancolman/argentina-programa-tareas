...
$botonCalcular.onclick = function calcular(){
  ...
  let salarioMensualText= document.querySelector("#salario-mensual");

  
  const sueldoMensual = sueldoAnual / 12;
  salarioMensualText.value = sueldoMensual;
  }
...
const selectorBody = document.querySelector("body");
 ...
 const relleno = document.createTextNode("este texto lo cree yooooooo!!!!!! con js");

 function agregarContenido(){


     nuevoParrafo.appendChild(relleno);
     nuevoDiv.appendChild(nuevoParrafo);
     selectorBody.appendChild(nuevoDiv); 
